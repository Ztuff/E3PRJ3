...
#include "../nySensorKonf/redigersenskonf2.h"
...
struct qt_meta_stringdata_redigersenskonf2_t {
    QByteArrayData data[4];
    char stringdata[63];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_redigersenskonf2_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_redigersenskonf2_t qt_meta_stringdata_redigersenskonf2 = {
    {
...
QT_MOC_LITERAL(3, 40, 21)
    ...
    "redigersenskonf2\0on_backButton_clicked\0"
...
const QMetaObject redigersenskonf2::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_redigersenskonf2.data,
      qt_meta_data_redigersenskonf2,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_redigersenskonf2.stringdata))
