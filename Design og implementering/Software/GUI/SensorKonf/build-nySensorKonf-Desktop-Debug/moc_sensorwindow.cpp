...
const QMetaObjectExtraData SensorWindow::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SensorWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SensorWindow,
      qt_meta_data_SensorWindow, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SensorWindow::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SensorWindow))
