...
static const char qt_meta_stringdata_NySensorKonf[] = {
    "NySensorKonf\0\0on_backButton_clicked()\0"
    "arg1\0on_Sensordropdown_activated(QString)\0"
...
const QMetaObjectExtraData NySensorKonf::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject NySensorKonf::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_NySensorKonf,
      qt_meta_data_NySensorKonf, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &NySensorKonf::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_NySensorKonf))
